  ...
  <section class="work">
    ...
    <div class="row" v-if="services.length >= 1">
      <div
        ...
        :key="service.id"
        class="col-sm-6 col-lg-4 work-item"
      >
        <div class="inner">
          <h3>{{ service.title }}</h3>
          <p>
    ...
    <div class="row justify-content-center text-slice" style="margin-top: 78px">
      <p class="text-center">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas magna
        ligula, rutrum in venenatis aliquet, congue gravida lorem. Aliquam
        convallis orci a odio imperdiet, nec pharetra odio porta.
